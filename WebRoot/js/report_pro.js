...
function sqlValue(value)
{
        ...
        {  // alert("txt = ");
		 ...
		 // alert("ok!!!!!!!!!!!!!!!!= ");
		    message_list="&$"+name+"="+jsTrim(objectValue);
		  }
        }
		...
		else if(type == "DAT" ) //日期类型
        {
                ...
                switch(i)
                {
					 ...
					 case 0 :  return message_list="&$"+name+"_start"+"=&$"+name+"_end"+"=";
                                                
                     case 1 : message_list="&$"+name+"_start"+"="+datValue1+"&$"+name+"_end"+"=";
                                                 break ;
                     case 2 : message_list="&$"+name+"_start"+"=&$"+name+"_end"+"="+datValue2;
                                                 break ;
                     case 3 : message_list="&$"+name+"_start"+"="+datValue1+"&$"+name+"_end"+"="+datValue2;
                                                 break ;
