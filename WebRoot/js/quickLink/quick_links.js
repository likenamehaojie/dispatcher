...
jQuery(function($){
	//创建DOM
	var 
	quickHTML = '<div class="quick_links_panel"><div id="quick_links" class="quick_links"><a href="#top" class="return_top"><i class="top"></i><span>返回顶部</span></a><a href="'+smsUrl+'" target="_blank"><i class="message"></i><span>短消息</span></a><a href="'+account_order_url+'" target="_blank"><i class="setting"></i><span>个人提醒</span></a></div><div class="quick_toggle"><a href="javascript:;" class="toggle" title="展开/收起"></a></div></div><div id="quick_links_pop" class="quick_links_pop hide"></div>',
	...
	quickDataFns = {
		...
		my_qlinks: {
			title: '个人中心',
			content: '<div class="links"><ul><li><a href="'+account_order_url+'" target="_blank">个人提醒</a></li><li><a href="'+smsUrl+'" target="_blank">短消息</a></li></ul></div>',
			init: $.noop
		}
